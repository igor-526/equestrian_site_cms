...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_price_groups_name"), "price_groups", ["name"], unique=False
    )
    op.create_table(
        "prices",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["coat_color_id"], ["coat_color.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["horse_owner_id"], ["horse_owner.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["horse_id"], ["horse.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["service_id"], ["horse_service.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
